...
<head>
  ...
  <link href="../css/interests-style.css" rel="stylesheet">
</head>
<body>
    <div id="navibar">
        <div id="leftie">
    ...
    <dialog id="berry-modal" class="berry-modal">
        <div id="header1">
            ...
            <img id="berry-cancel" src="../media/berry-cancel.png">
        </div>
        <div id="contenthere">
            <div id="berry-slidebox">
                <img id="slideshow-frame" src="../media/slideshowbox.png">
                <img class="berry-vids" src="../media/videosong/1.png">
                <video autoplay muted loop class="berry-vids"><source src="../media/videosong/2.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids"><source src="../media/videosong/3.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids"><source src="../media/videosong/4.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids"><source src="../media/videosong/5.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids"><source src="../media/videosong/6.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids"><source src="../media/videosong/7.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids"><source src="../media/videosong/8.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids"><source src="../media/videosong/9.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids"><source src="../media/videosong/a.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids"><source src="../media/videosong/b.mp4" type="video/mp4"></video>
            </div>
            <div id="berry-slidebar">
                <div class="slidebar-content">
                    <img src="../media/videosongtitle/1.1.png">
                    <p>Presenting to you - a list of some of my most favorite songs over the last year! Please pay no mind to the fact that these are all kpop and jpop, I'm still struggling to find English songs that I really really like!</p>
                </div>
                <div class="slidebar-content">
                ...
                <div id="arrow-buttons">
                    ...
                    <img id="right" onclick="showSlides(1)" src="../media/arrow1.png">
                </div>
            </div>
        </div>
    </dialog>
    ...
    <dialog id="berry-modal2" class="berry-modal2">
        <div id="header3">
            <p>click the berry to exit</p>
            <img id="berry-cancel2" src="../media/berry-cancel.png">
        </div>
        <div id="contenthere2">
            <div id="berry-slidebox2">
                <img id="slideshow-frame2" src="../media/slideshowbox.png">
                <img class="berry-vids2" src="../media/videoseries/1.png">
                <video autoplay muted loop class="berry-vids2"><source src="../media/videoseries/2.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids2"><source src="../media/videoseries/3.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids2"><source src="../media/videoseries/4.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids2"><source src="../media/videoseries/5.mp4" type="video/mp4"></video>
                <video autoplay muted loop class="berry-vids2"><source src="../media/videoseries/6.mp4" type="video/mp4"></video>
            </div>
            <div id="berry-slidebar2">
                <div class="slidebar-content2">
                    <img src="../media/videoseriestitle/1.1.png">
                    <p>Here's a list of the top 5 shows I've enjoyed this past year! Perhaps you've seen some of them?</p>
                </div>
                <div class="slidebar-content2">
                    <img src="../media/videoseriestitle/2.png">
                    <p>GENRE: Anime, Music, Idols <br><br>As another year begins at Yuigaoka Girls' High School, ushering in a fresh batch of students, the school idol club Liella! is excited to expand their membership. However, Liella! is extremely popular due to the astounding talent they have continuously displayed; thus, new students lack the courage to even consider approaching the club, fearing the rigorous training that might lie ahead.</p>
                </div>
                <div class="slidebar-content2">
                    <img src="../media/videoseriestitle/3.png">
                    <p>GENRE: C-drama, Period Drama, Romance, Mystery, Action <br><br>Qiu Yan ft Qiao Xin (Bridgette Qiao) is the unloved daughter in Qiu household who goes toe-to-toe with the cold faced duke, Liang Yi ft Xu Zheng Xi (Jeremy Xu) as she fights for her life and happiness using her own wit in the face of antiquated views of society.</p>
                </div>
                <div class="slidebar-content2">
                    <img src="../media/videoseriestitle/4.png">
                    <p>GENRE: Anime, Isekai, Villainess, Romance, Mystery <br><br>A doomed villainess in a dating game realizes her fate and role, and seeks to prevent her doom by romantically connecting with the game's other villain.</p>
                </div>
                <div class="slidebar-content2">
                    <img src="../media/videoseriestitle/5.png">
                    <p>GENRE: K-drama, legal drama, romance <br>Brought to life by the fantastic performance of Park Eun-Bin, the show centers on 27 year old Woo Young-Woo, who graduated top of her class at both college and law school. Her impressive memory and thought process are only held back by one thing: she is diagnosed with autism spectrum disorder. Struggling in social interactions, Young-Woo tries to navigate the highs and lows of law through her work at Hanbada Law Firm.</p>
                </div>
                <div class="slidebar-content2">
                    <img src="../media/videoseriestitle/6.png">
                    <p>GENRE: Anime, Mystery, Action, Comedy <br><br>A spy on an undercover mission gets married and adopts a child as part of his cover. His wife and daughter have secrets of their own, and all three must strive to keep together.</p>
                </div>
                <div id="arrow-buttons2">
                    <img id="left2" onclick="showSlides2(-1)" src="../media/arrow2.png">
